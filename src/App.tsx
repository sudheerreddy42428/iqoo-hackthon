...
export const App: React.FC = () => {
  ...
  return (
    <ErrorBoundary>
      <div className="h-screen supports-[height:100dvh]:h-[100dvh] w-full max-w-full whitespace-pre-wrap break-words bg-dark-950 text-slate-100 flex flex-col font-sans selection:bg-cyan-500/30 selection:text-cyan-200 overflow-x-hidden">
