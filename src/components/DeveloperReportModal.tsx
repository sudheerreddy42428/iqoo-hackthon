...
${analysis.possibleSolutions?.map((sol, i) => `${i + 1}. ${sol}`).join('\\n') || 'None provided'}

## 14. AI Suggested Patch
...
## 16. Automatic Debug Eligibility
...
## 18. Synthesized Regression Test
\`\`\`kotlin
@Test
...
## 19. Developer Approval & Next Steps
- [ ] Review AI Patch (Section 14)
- [ ] Apply Changes locally or via ReproX Auto-Fix
- [ ] Run Regression Test (Section 18)
